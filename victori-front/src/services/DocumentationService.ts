...
import { setLoadingDoc, setLoadedDoc } from '../redux/reducers/app-reducer';
...
export class DocumentationService {
    ...
    initDoc = () => {
        this.dispatch(setLoadingDoc());
        HttpService.read("/api/documentations/1").then((response) => {
            ...
            this.dispatch(setLoadedDoc(response));
        });
    }
