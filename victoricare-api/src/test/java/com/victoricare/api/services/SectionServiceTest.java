...
public class SectionServiceTest {
    ...
    public void deleteSectionTest() {
        ...
        given(repository.findById(section.getId())).willReturn(Optional.of(section));
        willDoNothing().given(deletionHistoryService).doCreate(section, user.getId());
        // precondition
        willDoNothing().given(repository).delete(section);

        // action
        service.doDelete(deletionHistoryService, user, section.getId());
    ...
    @Test
    @Order(10)
    public void deleteSectionThrowException() {
