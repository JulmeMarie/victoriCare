...
public class MediaServiceTest {
    ...
    public void setup() {
        ...
        mediaInputDTO.setNature(TEST_NATURE);
    ...
    @Test
    @Order(1)
    @DisplayName("For a given correct mediaInputDTO, " +
            "we should create and return successfully a new media with a valid creation date and a valid creation author ID")
    ...
    public void deleteMediaTest() {
        ...
        given(repository.findById(media.getId())).willReturn(Optional.of(media));
        willDoNothing().given(deletionHistoryService).doCreate(media, user.getId());
        // precondition
        willDoNothing().given(repository).delete(media);

        // action
        service.doDelete(deletionHistoryService, user, media.getId());
    ...
    @Test
    @Order(10)
    public void deleteMediaThrowException() {
