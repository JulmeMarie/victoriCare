...
public class BabySitterServiceTest {
    ...
    public void doCreateBabySitterMustBeOKTest() {
        ...
        given(this.codeService.doCreate6()).willReturn(code);
    ...
    public void doDeleteBabySitterCareTaskMustBeOKTest() {
        ...
        willDoNothing().given(deletionHistoryService).doCreate(babySitter, onlineUser.getId());
        willDoNothing().given(repository).delete(babySitter);
        service.doDelete(deletionHistoryService, onlineUser.getId(), babySitter.getId());
    }

    @Test
    @Order(4)
    public void doDeleteBabySitterCareTaskNonExistingTest() {
        // precondition
        given(repository.findById(babySitter.getId())).willReturn(Optional.empty());
