...
public class ContactServiceTest {
    ...
    public void deleteContactTest() {
        ...
        willDoNothing().given(deletionHistoryService).doCreate(contact, user.getId());
        // precondition
        willDoNothing().given(repository).delete(contact);

        // action
        service.doDelete(deletionHistoryService, user, contact.getId());
    ...
    @Test
    @Order(10)
    public void deleteContactThrowException() {
