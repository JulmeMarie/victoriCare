...
public class RecoveryService implements IRecoveryService {
    ...
    @Autowired
    private IDeletionHistoryService deletionHistoryService;
    ...
    @Override
    public void doDelete(IDeletionHistoryService deletionHistoryService, User user, Integer id) {
        Recovery recovery = this.doGet(id);
        this.deletionHistoryService.doCreate(recovery, user.getId());
