...
public class ChildCareService implements IChildCareService {
    ...
    @Override
    public void doDelete(IDeletionHistoryService deletionHistoryService, User onlineUser, Long id) {
        ChildCare existingChildCare = this.doGet(onlineUser, id);
        deletionHistoryService.doCreate(existingChildCare, onlineUser.getId());
