...
public class BabySitterService implements IBabySitterService {
    ...
    public BabySitter doCreate(User user, BabySitterInputDTO dto) {
        ...
        BabySitter babySitter = BabySitter.builder()
                ...
                .code(this.codeService.doCreate6().getId())
                .build();
    ...
    @Override
    public void doDelete(IDeletionHistoryService deletionHistoryService, Integer onlineUserId, Long id) {
        BabySitter existingBabySitter = this.doGet(onlineUserId, id);
        deletionHistoryService.doCreate(existingBabySitter, onlineUserId);
