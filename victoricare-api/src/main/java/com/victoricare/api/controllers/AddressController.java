...
public class AddressController {
    ...
    @ResponseStatus(value = HttpStatus.ACCEPTED)
    public void onDelete(Authentication authentication, IDeletionHistoryService deletionHistoryService,
            @PathVariable Integer id) {
        service.doDelete(deletionHistoryService, AuthFilter.getOnlineUser(authentication).getId(), id);
    }
