...
CREATE TABLE `media` (
  ...
  `media_nature` varchar(6) DEFAULT NULL,
...
CREATE TABLE `deletion_history` (
  `deletion_history_id` bigint(20) UNSIGNED PRIMARY KEY AUTO_INCREMENT,
  `deletion_history_table` varchar(10) NOT NULL,
  `deletion_history_creation_date` datetime NOT NULL,
  `deletion_history_line` varchar(10000) NOT NULL,
  `deletion_history_creation_author` int(11) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
