...
public enum ERole {
	...
	PRESIDENT, SECRETARY, TRESURER, TEAM, MEMBER, ALL, NONE;
	...
	public static List<ERole> compute(ERole role) {
		return Stream.of(ERole.values()).filter(r->{
			if(r.equals(role) || role.equals(ERole.ALL) || (!(r.equals(ERole.NONE) || r.equals(ERole.MEMBER) || r.equals(ERole.ALL)) && role.equals(ERole.TEAM))) return true;
			return false;
